	...
	FActorComponentTickFunction* ThisTickFunction)
{
	...
	if (UseParentActorLabelAsParentFrame)
	{
		...
		if (ParentActor)
		{
			...
			UE_LOG(LogROS, Error, TEXT("[TFBroadcast] UseParentActorLabelAsParentFrame==true and No Parent Component on %s - Add a parent actor or deactive UseParentActorLabelAsParentFrame"), *(GetOwner()->GetActorLabel()));
		}
	}
#endif // WITH_EDITOR
